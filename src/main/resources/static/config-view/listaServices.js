                ...
                for (var i = 0; i < json.length; i++) {
                    $('.carga-lista')
                        .append('<tr>' +
                            ...
                            '<td>' + json[i].year + '</td>' +
                            '<td>' + json[i].description + '</td>' +
                            '<td><a href="../pages/cars/car-details.html?id='+ json[i].idCar+ '">Mas información</a></td>' +
                            '</tr>');
                }
            }
        },
                ...
                for (var i = 0; i < json.length; i++) {
                    $('.carga-lista-client')
                        .append('<tr>' +
                            ...
                            '<td><a href="../pages/clients/client-details.html?id=' + json[i].idClient + '">Mas información</a></td>' +
                            '</tr>');
                }
            }
        },
                ...
                for (var i = 0; i < json.length; i++) {
                    $('.carga-lista-message')
                        .append('<tr>' +
                            ...
                            '<td><a href="../pages/messages/message-details.html?id=' + json[i].idMessage + '">Mas información</a></td>' +
                            '</tr>');
                }
            }
        },
                ...
                for (var i = 0; i < json.length; i++) {
                    $('.carga-lista-reservation')
                        .append('<tr>' +
                            ...
                            '<td>' + json[i].status + '</td>' +
                            '<td><a href="../pages/reservations/reservation-details.html?id=' + json[i].idReservation + '">Mas información</a></td>' +
                            '</tr>');
                }
            }
        },
